...
**Tests**: Per Constitution (Testing & Debugging Standards), all core logic MUST have unit tests with >80% coverage. Test tasks are included below and MUST be implemented. WFP interactions MUST be abstracted through interfaces for testability.
...
- [ ] TXXX [P] Additional unit tests to ensure >80% coverage in tests/unit/
